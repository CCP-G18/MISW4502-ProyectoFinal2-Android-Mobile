...
const val SELLER_CUSTOMER_RECOMMENDATIONS_BASE_ROUTE = "seller_customer_recommendations"
const val SELLER_CUSTOMER_RECOMMENDATIONS_ROUTE =
    "$SELLER_CUSTOMER_RECOMMENDATIONS_BASE_ROUTE/{$CUSTOMER_ID_ARG}"
const val SELLER_CUSTOMER_VISITS_BASE_ROUTE = "seller_customer_visits"
const val SELLER_CUSTOMER_VISITS_ROUTE = "$SELLER_CUSTOMER_VISITS_BASE_ROUTE/{$CUSTOMER_ID_ARG}"
const val SELLER_REGISTER_VISIT_BASE_ROUTE = "seller_register_visit"
const val SELLER_REGISTER_VISIT_ROUTE = "$SELLER_REGISTER_VISIT_BASE_ROUTE/{$CUSTOMER_ID_ARG}"
